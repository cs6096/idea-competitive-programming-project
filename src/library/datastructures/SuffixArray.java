...
public class SuffixArray {
  ...
  // suffix array in O(vertexNumber*log(vertexNumber))
  public static int[] suffixArray(CharSequence str) {
    ...
    // stable sort of characters. java7 comparator (MWAHAHHAHAHAHAHAHAHA)
    comp1.str = str;
    ...
    for (int len = 1; len < n; len *= 2) {
      int[] r = rank.clone();
      for (int i = 0; i < n; i++) {
        // condition s1 + len < vertexNumber simulates 0-symbol at the end of the string
  ...
  // longest common prefixes array in O(vertexNumber)
